...
# To convert a Khulnasoft Rule from a Sigma rule (for testing purposes) use:
# khulnasoft_backend.convert(sigma_rule, output_format="siem_rule")
...
# Helper function to runs assertions checking to see if Khulnasoft rule structure is accurate
...
def test_khulnasoft_complex_expressions(khulnasoft_backend: KhulnasoftBackend):
    assert (
        khulnasoft_backend.convert(
            SigmaCollection.from_yaml(
                """
...
def test_khulnasoft_filters(khulnasoft_backend: KhulnasoftBackend):
    assert (
        khulnasoft_backend.convert(
            SigmaCollection.from_yaml(
                """
...
def test_khulnasoft_wildcard_expression(khulnasoft_backend: KhulnasoftBackend):
    assert (
        khulnasoft_backend.convert(
            SigmaCollection.from_yaml(
                """
...
#################################### Sigma to Khulnasoft Rule Conversion Tests ##########################################
def test_khulnasoft_siem_rule_output(khulnasoft_backend: KhulnasoftBackend):
    ...
    dd_rule_from_sigma_rule = khulnasoft_backend.convert(
...
def test_khulnasoft_siem_rule_output_with_tags(khulnasoft_backend: KhulnasoftBackend):
    sigma_rule = SigmaCollection.from_yaml(
        """
...
def test_cloudtrail_rule(khulnasoft_backend: KhulnasoftBackend):
    sigma_rule = SigmaCollection.from_yaml(
        """
...
def test_cloudtrail_rule_with_filters(khulnasoft_backend: KhulnasoftBackend):
    sigma_rule = SigmaCollection.from_yaml(
        """
...
def test_azure_rule_from_auditlogs(khulnasoft_backend: KhulnasoftBackend):
    sigma_rule = SigmaCollection.from_yaml(
        """
...
def test_azure_rule_from_signin(khulnasoft_backend: KhulnasoftBackend):
    sigma_rule = SigmaCollection.from_yaml(
        """
...
def test_gcp_rule(khulnasoft_backend: KhulnasoftBackend):
    sigma_rule = SigmaCollection.from_yaml(
        """
        title: Test GCP Rule
        id: 3bc0427d-b76f-4f26-95bf-78b8d7903dbd
